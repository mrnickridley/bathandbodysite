const loginPageNavBody = document.getElementById("loginPageBody");
...
function navigationBar(){
    ...
    signInAnchor.href = "loginpage.html";
...
navigationBar();
loginPageNavBody.appendChild(navBar);
//NAVIGATION PART OF THE BODY/---------///////--------/
...
memberNameInNav();
memberLogout();
loginPageNavBody.appendChild(optionBar);
//OPTION BAR PART OF THE BODY/---------///////--------/