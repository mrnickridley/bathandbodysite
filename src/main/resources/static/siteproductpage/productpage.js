const productPageBody = document.getElementById("productPageBody");
...
const memeberStorage = localStorage.getItem('memberUsername');
/*---SORT BOXES SECTION---*/
...
sortBySexOptions.className = "sortBySexOptions";

sortBySexOptionsTwo.value = "Him";
sortBySexOptionsTwo.textContent = "HIM";
sortBySexOptionsTwo.className = "sortBySexOptions";
...
productPageBody.appendChild(sortBoxCon);
/*---SORT BOXES SECTION---*/
...
function productsRender(data){
    ...
    data.forEach(products => {
        ...
        productPageBody.appendChild(productsList);
...
function productPopUp(products){
    ...
    productPageBody.appendChild(productsListTwo);
...
function categorySort(sortOptions){
    let categorySort;
    if(sortOptions === "Bodywash"){
        categorySort = productArrayThree.filter(a => a.productcategory === "Bodywash");
    } else if(sortOptions === "Soap"){
        categorySort = productArrayThree.filter(a => a.productcategory === "Soap");
    } else if(sortOptions === "Shampoo"){
        categorySort = productArrayThree.filter(a => a.productcategory === "Shampoo");
    } else if(sortOptions === "Conditioner"){
        categorySort = productArrayThree.filter(a => a.productcategory === "Conditioner");
    } else if(sortOptions === "Lotion"){
        categorySort = productArrayThree.filter(a => a.productcategory === "Lotion");
    } else if(sortOptions === "Handsoap"){
        categorySort = productArrayThree.filter(a => a.productcategory === "Handsoap");
    } else if(sortOptions === "Dental"){
        categorySort = productArrayThree.filter(a => a.productcategory === "Dental");
    } else if(sortOptions === "Towels"){
        categorySort = productArrayThree.filter(a => a.productcategory === "Towels");
    } else if(sortOptions === "Accessories"){
        categorySort = productArrayThree.filter(a => a.productcategory === "Accessories");
    } else {
        categorySort = productArrayThree;
    }

    productsRender(categorySort);
}
